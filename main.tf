...
resource "aws_route_table_association" "public-aassociation" {
  subnet_id      = aws_subnet.public-subnet-a.id
  route_table_id = aws_route_table.public-route.id
}

resource "aws_route_table_association" "public-bassociation" {
...
resource "aws_route_table_association" "private-aassociation" {
  subnet_id      = aws_subnet.private-subnet-a.id
  route_table_id = aws_route_table.private-route-a.id
}

resource "aws_route_table_association" "private-bassociation" {
